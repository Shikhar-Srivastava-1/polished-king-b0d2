...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/polished-king-b0d2#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-king-b0d2
```

A live public deployment of this template is available at [https://polished-king-b0d2.templates.workers.dev](https://polished-king-b0d2.templates.workers.dev)
